...
\begin{center}
\includegraphics[totalheight=.3\textheight]{wasplightcurve.png}
...
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{comp1r.png}
  \label{fig:comp1}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{comp2r.png}
  \label{fig:comp2}
\endminipage\hfill
\minipage{0.32\textwidth}%
  \includegraphics[width=\linewidth]{comp3r.png}
  \label{fig:comp3}
\endminipage
